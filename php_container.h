...
#define PHP_CONTAINER_H

extern zend_module_entry container_module_entry;
#define phpext_container_ptr &container_module_entry

#define PHP_CONTAINER_VERSION "0.1.0" /* Replace with version number for your extension */

#ifdef PHP_WIN32
#	define PHP_CONTAINER_API __declspec(dllexport)
#elif defined(__GNUC__) && __GNUC__ >= 4
#	define PHP_CONTAINER_API __attribute__ ((visibility("default")))
#else
...
/* Always refer to the globals in your function as CONTAINER_G(variable).
   You are encouraged to rename these macros something shorter, see
   examples in any other php module directory.
*/
#define CONTAINER_G(v) ZEND_MODULE_GLOBALS_ACCESSOR(container, v)

#if defined(ZTS) && defined(COMPILE_DL_CONTAINER)
ZEND_TSRMLS_CACHE_EXTERN()
#endif

#endif	/* PHP_CONTAINER_H */
